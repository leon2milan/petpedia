...
from qa.matching.semantic.simCSE.vocab import Vocab
import unicodedata
import six
import json


with open("simcse/special_tokens_map.json", mode="r", encoding="utf-8") as f:
...
class CharTokenizer(Tokenizer):
    ...
    def tokenize(self, text, use_vocab=True):
        if use_vocab:
            return [
                token if token in self.vocab else UNK_TOKEN
