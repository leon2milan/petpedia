...
def finetune_opts(parser):
    ...
    parser.add_argument("--config_path", default="simcse/config.json", type=str,
...
def infer_opts(parser):
    # Path options.
    parser.add_argument("--load_model_path", default='simcse', type=str,
...
def tokenizer_opts(parser):
    ...
    parser.add_argument("--vocab_path", default='./simcse/vocab.txt', type=str,
