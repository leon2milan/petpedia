...
class ModelTest(unittest.TestCase):
    ...
    def test_predict(self):
        expect_output = {
            ...
            'models/retrieval/W2V_fine_hnsw.bin': 363889602,
            'models/retrieval/W2V_rough_hnsw.bin': 363890122,
            'models/representation/simcse_unsup.pt': 409159223,
            'models/representation/embedding/fine_word2vec.bin': 169211118,
            'models/representation/embedding/char_word2vec.bin': 13125942,
            'models/representation/embedding/rough_word2vec.bin': 177497160,
