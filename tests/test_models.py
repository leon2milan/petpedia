...
class ModelTest(unittest.TestCase):
    ...
    def test_predict(self):
        expect_output = {
            ...
            'models/retrieval/W2V_fine_hnsw.bin': 96367172,
            'models/retrieval/W2V_rough_hnsw.bin': 96367172,
            'models/representation/simcse_unsup.pt': 409159223,
            'models/representation/embedding/fine_word2vec.bin': 152605245,
            'models/representation/embedding/char_word2vec.bin': 12235979,
            'models/representation/embedding/rough_word2vec.bin': 166584166,
