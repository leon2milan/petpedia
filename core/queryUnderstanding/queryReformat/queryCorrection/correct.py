...
from core.matching.lexical.lexical_similarity import LexicalSimilarity
from core.queryUnderstanding.queryReformat.queryCorrection.bk_tree import \
    BKTree
...
from core.queryUnderstanding.representation.ngram import BiGram
from core.tools import flatten, setup_logger
from core.tools.trie import Trie
...
class SpellCorrection(object):
    ...
    def init(self):
        ...
        if not os.path.exists(kenlm_path):
            from core.queryUnderstanding.representation.kenlm import KenLM
            km = KenLM(self.cfg)
            km.write_corpus(
