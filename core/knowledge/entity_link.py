...
from core.queryUnderstanding.representation import W2V
from core.queryUnderstanding.querySegmentation import Segmentation, Words
from core.queryUnderstanding.queryReformat.queryNormalization.normalize import Normalization
...
class EntityLink(object):
    ...
    def entity_recall(self, query):
        ...
        normalize = [x for x in normalize if x]
        return normalize
